...
const whySvbb = [
  {
    ...
    desc: "Deep knowledge of Vietnam's business landscape, regulations, and commercial culture across key sectors.",
  },
  {
    icon: Handshake,
    title: "Business Matching & Partner Access",
    desc: "Direct access to qualified distributors, agents, resellers, and strategic partners across Vietnam.",
  },
  {
    icon: Languages,
    title: "Bilingual Cross-Border Execution",
    desc: "English-Vietnamese coordination for meetings, negotiations, and follow-ups — no communication gaps.",
  },
  {
    icon: Building2,
    title: "SME-Friendly Project Structure",
    desc: "Packages scoped for Singapore SMEs — clear deliverables, fixed pricing, and structured timelines.",
  },
];
...
const services = [
  {
    ...
    desc: "Finding agents, distributors, strategic partners, resellers, or franchisees suited to your product, sector, and expansion goals.",
  },
  {
    icon: Search,
    title: "Feasibility Studies & Market Research",
    desc: "Understanding market size, competitive landscape, regulatory requirements, and go-to-market viability before committing resources.",
  },
  {
    icon: Briefcase,
    title: "In-Market BD Consultancy",
    desc: "Outsourced business development support — prospecting, outreach, meeting coordination, and pipeline management on the ground in Vietnam.",
  },
  {
    icon: Target,
    title: "Distributor & Reseller Qualification",
    desc: "Systematic identification, qualification, and shortlisting of local distribution, reseller, or franchise partners with structured scorecards.",
  },
];
...
const comparisonRows: { label: string; values: (string | boolean)[] }[] = [
  ...
  {
    label: "Strategy deliverables",
    values: ["Recommendation deck", "Channel strategy + scorecard", "Pipeline tracker", "Full action plan"],
  },
  {
    label: "Recommended stage",
    values: ["Exploring", "Ready to partner", "In-market execution", "Full market launch"],
  },
];
...
const steps = [
  {
    step: "01",
    title: "Discover",
    desc: "Understand your business goals, product-market fit, and Vietnam entry objectives.",
  },
  {
    step: "02",
    title: "Validate",
    desc: "Assess the market, customer segments, competitive landscape, and route to market.",
  },
  {
    step: "03",
    title: "Connect",
    desc: "Identify, approach, and introduce the right local partners, distributors, or channels.",
  },
  {
    step: "04",
    title: "Execute",
    desc: "Support meetings, negotiations, follow-ups, and ongoing pipeline development.",
  },
];
...
const outcomes = [
  {
    icon: Target,
    title: "Better Partner Fit",
    desc: "Structured qualification reduces mismatches and ensures partners align with your goals, sector, and scale.",
  },
  {
    icon: Zap,
    title: "Faster Market Validation",
    desc: "Skip months of self-research. Get a clear picture of market viability and route-to-market options early.",
  },
  {
    icon: Shield,
    title: "Reduced Trial-and-Error",
    desc: "A structured engagement replaces ad-hoc efforts with a clear plan, measurable milestones, and qualified introductions.",
  },
];

const faqs = [
  {
    q: "What types of companies are these packages suitable for?",
    a: "These packages are designed for Singapore-registered SMEs looking to enter or expand in Vietnam — whether you're exploring the market for the first time or ready to establish distribution channels.",
  },
  {
    q: "Can SVBB help us find distributors in Vietnam?",
    a: "Yes. Distributor, reseller, and agent identification is a core part of our service. We systematically longlist, qualify, and shortlist potential partners based on your sector, product, and commercial requirements.",
  },
  {
    q: "Do you support business matching and local meetings?",
    a: "Absolutely. We coordinate introductions, arrange meetings with qualified prospects, and provide bilingual support for discussions and follow-ups.",
  },
  {
    q: "How long does a typical engagement take?",
    a: "Most packages run between 2 to 6 months depending on scope. Entry Lite is typically 8–10 weeks, while BD Accelerator and Market Launch Pro run for 6 months.",
  },
  {
    q: "Are these packages suitable for MRA-supported overseas expansion projects?",
    a: "Our packages are structured with clear deliverables and timelines that align well with Singapore SME overseas expansion planning frameworks. We can discuss how this applies to your specific situation during a consultation.",
  },
  {
    q: "What happens after the first package ends?",
    a: "We can continue with follow-on BD support, partner management, or escalate to a more comprehensive package. Many clients start with Entry Lite and progress to Channel Builder or BD Accelerator.",
  },
];
      ...
      <section id="bd-hero" className="relative min-h-[85vh] flex items-end overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4 pt-28 pb-20">
          <div className="max-w-3xl">
            <span className="inline-block font-body text-xs font-semibold tracking-widest uppercase text-gold mb-4">
              Business Development Services
            </span>
            <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-primary-foreground leading-tight mb-6">
              Vietnam Market Entry and Business Development for{" "}
              <span className="text-gradient-gold">Singapore SMEs</span>
            </h1>
            <p className="font-body text-primary-foreground/70 text-lg md:text-xl max-w-2xl mb-8 leading-relaxed">
              From market validation to partner search and in-market execution, SVBB helps Singapore companies build the
              right foothold in Vietnam.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 mb-4">
              <button
                onClick={scrollToContact}
                className="inline-flex items-center justify-center gap-2 bg-gradient-gold text-secondary-foreground px-8 py-3.5 rounded-lg font-body font-semibold text-sm shadow-gold hover:opacity-90 transition-opacity"
              >
                Book a Consultation <ArrowRight size={16} />
              </button>
              <button
                onClick={scrollToPackages}
                className="inline-flex items-center justify-center gap-2 border border-gold/40 text-gold px-8 py-3.5 rounded-lg font-body font-semibold text-sm hover:bg-gold/10 transition-colors"
              >
                View Packages
              </button>
            </div>
            <p className="font-body text-primary-foreground/40 text-sm">
              Structured for SMEs. Built for Vietnam market entry.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {whySvbb.map((w) => (
              <div
                key={w.title}
                className="bg-card rounded-2xl border border-border p-6 hover:shadow-lg hover:border-gold/30 transition-all"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-14">
            ...
            <p className="font-body text-muted-foreground mt-4 max-w-2xl mx-auto">
              Practical, outcomes-focused services designed to help Singapore SMEs establish distribution, find
              partners, and build commercial traction in Vietnam.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {services.map((s) => (
              <div
                key={s.title}
                className="bg-card rounded-2xl border border-border p-8 hover:border-gold/30 hover:shadow-lg transition-all"
              >
                <div className="w-12 h-12 rounded-xl bg-gold/10 flex items-center justify-center mb-4">
      ...
      <section id="bd-packages" className="py-20 bg-cream">
        <div className="container mx-auto px-4">
          <div className="text-center mb-14">
            ...
            <p className="font-body text-muted-foreground mt-4 max-w-2xl mx-auto">
              Fixed-scope packages with clear deliverables — designed for Singapore SMEs at different stages of Vietnam
              market entry.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {packages.map((pkg) => (
              <div
                key={pkg.name}
                className={`bg-card rounded-2xl border p-6 relative flex flex-col ${pkg.badge ? "border-gold shadow-lg ring-2 ring-gold/30" : "border-border"}`}
              >
                {pkg.badge && (
                ...
                <span className="font-body text-xs font-semibold text-gold-dark uppercase tracking-widest">
                  {pkg.name}
                </span>
                ...
                <button
                  onClick={scrollToContact}
                  className="mt-6 w-full bg-gradient-gold text-secondary-foreground py-2.5 rounded-lg font-body font-semibold text-sm shadow-gold hover:opacity-90 transition-opacity"
                >
                  Request Proposal
                </button>
              </div>
              ...
              <thead>
                <tr className="border-b border-border">
                  ...
                  {packages.map((p) => (
                    <th
                      key={p.name}
                      className={`text-center font-body text-xs font-bold uppercase tracking-wider py-4 px-3 min-w-[140px] ${p.badge ? "text-gold-dark" : "text-muted-foreground"}`}
                    >
                      {p.name}
                    </th>
                  ))}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {steps.map((s, i) => (
              <div
                key={s.step}
                className="relative bg-navy-light/30 border border-gold/20 rounded-xl p-6 hover:border-gold/50 transition-colors"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto bg-navy-light/30 border border-gold/20 rounded-2xl p-8 md:p-12 text-center">
            ...
            <p className="font-body text-primary-foreground/60 text-sm mb-6 max-w-lg mx-auto">
              Download our free checklist covering the key steps, documents, and considerations for Singapore SMEs
              planning a Vietnam market entry.
            </p>
            ...
            {faqs.map((faq, i) => (
              <div key={i} className="bg-card rounded-xl border border-border overflow-hidden">
                ...
                >
                  ...
                  {openFaq === i ? (
                    <ChevronUp size={18} className="text-gold-dark shrink-0" />
                  ) : (
      ...
      <section id="bd-contact" ref={contactRef} className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            <div>
              <span className="text-gold-dark font-body text-sm font-semibold tracking-widest uppercase">
                Get Started
              </span>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@svbb.sg" className="font-body text-sm text-gold-dark hover:underline">
                      info@svbb.sg
                    </a>
                  </div>
                </div>
              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-lg border border-border bg-background font-body text-sm focus:outline-none focus:ring-2 focus:ring-gold/50"
                    placeholder="e.g. F&B, Technology, Manufacturing"
                  />
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-lg border border-border bg-background font-body text-sm focus:outline-none focus:ring-2 focus:ring-gold/50 h-24 resize-none"
                    placeholder="Tell us about your Vietnam expansion plans..."
                  />
                </div>
                <button
                  type="submit"
                  className="w-full bg-gradient-gold text-secondary-foreground py-3 rounded-lg font-body font-semibold shadow-gold hover:opacity-90 transition-opacity"
                >
                  Submit Inquiry
                </button>
              </form>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 items-start">
            <div>
              ...
              <p className="font-body text-primary-foreground/50 text-sm leading-relaxed max-w-xs">
                SVBB (Singapore Vietnam Business Bridge) — helping Singapore SMEs enter Vietnam with structured market
                entry, business matching, and in-market execution support.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <a
                  href="mailto:info@svbb.sg"
                  className="flex items-center gap-2 font-body text-sm text-primary-foreground/50 hover:text-gold transition-colors"
                >
                ...
                <a
                  href="https://linkedin.com/company/svbb"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 font-body text-sm text-primary-foreground/50 hover:text-gold transition-colors"
                >
          ...
          <div className="border-t border-gold/10 mt-8 pt-6 text-center">
            <p className="font-body text-xs text-primary-foreground/30">
              © {new Date().getFullYear()} SVBB. All rights reserved.
            </p>
          </div>
        </div>
      </footer>

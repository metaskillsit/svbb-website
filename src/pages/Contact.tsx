...
const Contact = () => {
  return (
    <div className="min-h-screen">
      <Navbar />
      <section className="relative min-h-[55vh] flex items-end overflow-hidden"> className="relative min-h-[55vh] flex items-end overflow-hidden"> className="relative min-h-[55vh] flex items-end overflow-hidden"> flex items-end overflow-hidden">

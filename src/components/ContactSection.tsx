            ...
            <div className="bg-navy rounded-xl p-8 text-primary-foreground">
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <span
                    key={industry}
                    className="px-3 py-1 rounded-full border border-gold/30 text-xs font-body text-gold"
                  >
                    {industry}
                  </span>
                ))}
          ...
          <div className="bg-card rounded-xl p-8 border border-border">
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              ...
              <div>
                ...
                <textarea
                  className="w-full px-4 py-3 rounded-lg border border-border bg-background font-body text-sm focus:outline-none focus:ring-2 focus:ring-gold/50 h-28 resize-none"
